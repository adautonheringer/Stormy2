...
import cozo.stormy2.weather.Current;
import cozo.stormy2.weather.Day;
import cozo.stormy2.weather.Forecast;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final double latitude = -23.533773;
        final double longitude = -46.625290;
    ...
    private void getForecast(double latitude, double longitude) {
        String apiKey = "db003214b84fe9b9769211cdf9ceb43d";
    ...
    private void updateDisplay() {
        ...
        mTemperature.setText(Math.round(mForecast.getCurrent().getTemperature()) + "");
        mHumidityValue.setText(mForecast.getCurrent().getHumidity() + "");
        mPrecipValue.setText(Math.round(mForecast.getCurrent().getPrecipChance()) + "%");
